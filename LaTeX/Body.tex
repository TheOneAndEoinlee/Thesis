...
% The specific derivation of the force-displacement response is detailed in Appendix \ref*{sec:Force-displacement response of the tristable element}.
...
\begin{figure}{H}
    \centering
    \includegraphics[width=\textwidth]{images/Rule110Simulation.png}
    \caption{This is a figure.}
